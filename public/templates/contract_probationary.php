...
// Capitalize Section nicely (e.g., "Light Maintenance")
$section  = ucwords(strtolower($emp['section'])); 
...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-size: 11pt; /* Standard legal size */
        ...
        .indent  { text-indent: 0.5in; } /* Standard legal indent */
        ...
        /* 5. LISTS */
        ul.functions { margin: 0 0 15px 0; padding-left: 0.5in; text-align: justify; }
        ul.functions li { margin-bottom: 5px; padding-left: 5px; }

        /* 6. SIGNATURES */
        .sig-table { width: 100%; margin-top: 80px; page-break-inside: avoid; }
    ...
    <tbody>
        <tr>
            <td>
                ...
                <p class="justify">
                    That the EMPLOYEE is being engaged for a Probationary Appointment as <span class="bold uppercase"><?php echo $position; ?></span> for a maximum period of 6 Months taking effect on <span class="bold"><?php echo $contract_period; ?></span> and will be assigned to the <span class="bold uppercase"><?php echo $section; ?></span> Section.
                </p>
                ...
                <ul class="functions">
                    <li>Checks and validates the cause of train failures as needed to fix the problem.</li>
                    <li>Fixes the identified train failures based on troubleshooting standard.</li>
                    <li>Documents and encodes the actions taken on the Maintenance Monitoring System.</li>
                    <li>Monitors if there are another rework to be done as needed.</li>
                    <li>Checks the quality of newly delivered spare parts if in good condition and with quality standard.</li>
                    <li>Assists on the orientation of the new Technicians to guide on their tasks.</li>
                </ul>
