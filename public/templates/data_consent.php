...
<head>
    <meta charset="UTF-8">
    <title>Employee Personal Data Consent Statement - <?php echo htmlspecialchars($emp['last_name']); ?></title>
    <style>
        /* MAXIMIZE PAPER SPACE */
        @page {
            size: A4;
            margin: 0.5in;
        }
                ...
                <td>
                    ...
                    <ol class="level-1">
                        <li>Without limiting the rights of <strong>TES Philippines, Inc.</strong> (“Company") under and subject to applicable law, by signing this Employee Personal Data Consent Statement ("Consent Statement") , I consent to the Company, any Affiliate and any third party acting on its or their behalf:
                            <ol class="level-2">
                                <li>To Process my Personal Data for any purpose directly or indirectly connected with:
                                    ...
                                    <p>(collectively the "Purposes"); and</p>
                                </li>
                        ...
                        <li>For the purposes of this Consent Statement:
                            <p><strong>"Affiliate"</strong> means corporation, entity or other organisation which:</p>
                            <ol class="level-3">
                            ...
                            <p>and where the term "control" when used with respect to any organisation means the ownership of fifteen per cent (15%) of issued shares or more.</p>

                            <p><strong>“Business asset transaction"</strong> has the meaning as defined under the Data Privacy Act of 2012” & ”Republic Act No. 10173.</p>

                            <p><strong>"Personal Data"</strong> refers to data, whether true or not, about an individual who can be identified from that data, or from that data in combination with other information to which the organisation may have access.</p>

                            <p><strong>"Processing”</strong> includes recording, holding, organisation, adaptation or alteration, retrieval, combination, transmission, erasure, obtaining, copying, amending, adding, deleting, extracting, storing, disclosing, Transferring or destruction of Personal Data.</p>

                            <p><strong>"Transferring"</strong> refers to transferring Personal Data outside of the Philippines, whether by electronic (e.g. cloud storage, email, etc.) or physical means (e.g. shipping physical files).</p>
                        </li>
                    </ol>
