    ...
    <nav class="navbar navbar-dark bg-dark mb-4">
        <div class="container">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <span class="navbar-text text-white"><i class="bi bi-journal-text"></i> System Instructions & Manual</span>
                <span class="navbar-text text-white-50 ms-3 font-monospace small d-none d-md-inline"><i class="bi bi-clock"></i> <span id="sessionTimer"></span></span>
            </div>
        </div>
    </nav>
