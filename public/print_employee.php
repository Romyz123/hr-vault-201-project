...
<head>
    ...
    @page {
        size: A4;
        margin: 0; /* Important: Removes default browser header/footer urls */
    }
    ...
    @media print {
        ...
        .page {
            ...
            width: 100% !important;
            page-break-after: always; /* Ensures multi-page profiles print cleanly */
        }
    }
    ...
    /* 4. Content Styling */
    .profile-img { width: 120px; height: 120px; object-fit: cover; border: 1px solid #333; }
    .section-title { 
    ...
    .data-label { font-weight: 600; color: #555; font-size: 0.9rem; text-transform: uppercase; }
    .data-value { font-weight: bold; font-size: 1rem; border-bottom: 1px dotted #ccc; padding-bottom: 2px; margin-bottom: 10px; }
</style>
</head>
<body>
...
onerror="this.onerror=null; this.src='data:image/svg+xml;base64,';">
    ...
    <div class="row g-3">
        ...
        <div class="col-12"><div class="data-label">Permanent Address</div><div class="data-value"><?php echo $emp['permanent_address']; ?></div></div>
    </div>

    <div class="section-title">Employment Details</div>
    <div class="row g-3">
        <div class="col-6"><div class="data-label">Employment Type</div><div class="data-value"><?php echo $emp['employment_type']; ?></div></div>
        <div class="col-6"><div class="data-label">Agency (If Applicable)</div><div class="data-value"><?php echo $emp['agency_name']; ?></div></div>
        <div class="col-4"><div class="data-label">Date Hired</div><div class="data-value"><?php echo $emp['hire_date']; ?></div></div>
        <div class="col-4"><div class="data-label">Department</div><div class="data-value"><?php echo $emp['dept']; ?></div></div>
        <div class="col-4"><div class="data-label">Section</div><div class="data-value"><?php echo $emp['section']; ?></div></div>
    </div>

    <div class="section-title">Government Contributions</div>
    <div class="row g-3">
        <div class="col-3"><div class="data-label">SSS Number</div><div class="data-value"><?php echo $emp['sss_no']; ?></div></div>
        <div class="col-3"><div class="data-label">TIN Number</div><div class="data-value"><?php echo $emp['tin_no']; ?></div></div>
        <div class="col-3"><div class="data-label">PhilHealth</div><div class="data-value"><?php echo $emp['philhealth_no']; ?></div></div>
        <div class="col-3"><div class="data-label">Pag-IBIG</div><div class="data-value"><?php echo $emp['pagibig_no']; ?></div></div>
    </div>

    <div class="section-title">In Case of Emergency</div>
    <div class="row g-3">
        <div class="col-6"><div class="data-label">Contact Person</div><div class="data-value"><?php echo $emp['emergency_name']; ?></div></div>
        <div class="col-6"><div class="data-label">Contact Number</div><div class="data-value"><?php echo $emp['emergency_contact']; ?></div></div>
        <div class="col-12"><div class="data-label">Address</div><div class="data-value"><?php echo $emp['emergency_address']; ?></div></div>
    </div>
    ...
    <table class="table table-sm table-bordered mt-2" style="font-size: 0.85rem;">
        <thead class="table-light">
            <tr><th>Document Name</th><th>Category</th><th>Date Uploaded</th></tr>
        </thead>
        <tbody>
            ...
            <?php endforeach; else: ?>
            <tr><td colspan="3" class="text-center text-muted">No documents on file.</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
