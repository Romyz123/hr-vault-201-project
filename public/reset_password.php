    ...
    <div class="card" style="width: 420px;">
        ...
        <div class="card-body px-4 pb-4">
            ...
            <?php if ($step === 'verify'): ?>
                ...
                <form method="GET">
                    <div class="mb-4">
                        <input type="text" name="token" class="form-control otp-input" placeholder="000000" maxlength="6" required autofocus value="<?php echo htmlspecialchars($token); ?>" pattern="[0-9]*" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    </div>
                    <div class="d-grid">
