...
<head>
    ...
    <style>
        ...
        /* [DARK MODE FIX] Preview box in dark mode */
        ...
        /* [DARK MODE FIX] Highlight target in dark mode */
        [data-bs-theme=dark] .highlight-target {
            background: #3d3519 !important;
            border-color: #6b5a12 !important;
        }
    </style>
</head>
