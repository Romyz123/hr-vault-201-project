...
<body>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        ...
                        <?php if ($userRole === 'ADMIN'): ?>
                            ...
                            <li><a class="dropdown-item" href="system_health.php"><i class="bi bi-activity me-2 text-success"></i> System Health</a></li>
                            <li>
                            </li>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="section" id="exportSection" class="form-select" disabled>
                            ...
                            <optgroup label="DOS">
                                <option value="DEPARTMENT OPERATIONS SECTION">DEPARTMENT OPERATIONS SECTION</option>
                            </optgroup>
                            <optgroup label="SQP">
                            ...
                            <optgroup label="BFS">
                                <option value="BUILDING FACILITIES SECTION">BUILDING FACILITIES SECTION</option>
                            </optgroup>
                            <optgroup label="WHS">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            //setInterval(refreshSystem, 15000);  put on the refersh interval here in 15 second if fells something slow 
            // Run every 5 seconds
